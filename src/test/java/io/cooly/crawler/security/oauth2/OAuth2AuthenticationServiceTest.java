...
public class OAuth2AuthenticationServiceTest {
    ...
    private CoolybotProperties coolyProperties;

    @Before
    public void init() {
        oAuth2Properties = new OAuth2Properties();
        coolyProperties = new CoolybotProperties();
        coolyProperties.getSecurity().getClientAuthorization().setAccessTokenUri("http://uaa/oauth/token");
        ...
        authorizationClient = new UaaTokenEndpointClient(restTemplate, coolyProperties, oAuth2Properties);
