package io.cooly.crawler.gateway.ratelimiting;

import io.cooly.crawler.security.SecurityUtils;
...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(CoolybotProperties coolyProperties) {
    ...
    private Supplier<BucketConfiguration> getConfigSupplier() {
        return () -> {
            CoolybotProperties.Gateway.RateLimiting rateLimitingProperties =
                coolyProperties.getGateway().getRateLimiting();
