...
public abstract class OAuth2TokenEndpointClientAdapter implements OAuth2TokenEndpointClient {
    ...
    protected final CoolybotProperties coolyProperties;
    protected final OAuth2Properties oAuth2Properties;

    public OAuth2TokenEndpointClientAdapter(RestTemplate restTemplate, CoolybotProperties coolyProperties, OAuth2Properties oAuth2Properties) {
    ...
    protected String getTokenEndpoint() {
        String tokenEndpointUrl = coolyProperties.getSecurity().getClientAuthorization().getAccessTokenUri();
